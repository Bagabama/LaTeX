...
\begin{equation}
\begin{aligned}
O(A_{0},F_{j},S) &= \sum_{i=1}^{\text{длина}(S)}O(A_{0},F_{j},X_{i}) = \\
&= \sum_{i=1}^{\text{длина}(S)}\left(c_{1}\cdot N_{1}(X_{i},A_{0},F_{j})+c_{2}\cdot N_{2}(X_{i},A_{0},F_{j})+c_{3}\cdot N_{3}(X_{i},A_{0},F_{j})\right)
\end{aligned}
\end{equation}
...
R(g, X_{i}, A_{0}, F_{j}) =
\begin{cases}
0, & \text{если выходы элементов } g \text{ множества ЦУ,} \\
